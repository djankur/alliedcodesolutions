import { CheckCircle, Users, FileText, Briefcase, UserCheck, TrendingUp } from "lucide-react";
  ...
  const services = [
    {
      ...
      description:
        "We create ATS-friendly, recruiter-approved resumes tailored to your industry and experience level.",
      features: [
