...
export default function ContactPage() {
  ...
  const validateField = (field: string, value: string): string => {
    ...
    switch (field) {
      ...
      case 'subject':
      case 'message':
        if (!value.trim()) error = `${field[0].toUpperCase() + field.slice(1)} is required`;
        break;
    }
    return error;
  };
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="space-y-8">
                ...
                <p className="text-xl text-gray-300 leading-relaxed">
                  Ready to find your next opportunity or hire exceptional talent? Let's discuss how we can help you achieve your goals.
                </p>

                <div className="space-y-6">
                  <div className="flex items-start gap-4 group">
                    <div className="mt-1 p-3 bg-blue-500/20 rounded-lg group-hover:bg-blue-500/30 transition-colors">
                      <Mail className="w-6 h-6 text-blue-400" />
                    </div>
                    <div>
                      <h3 className="text-white font-semibold mb-1">Email Us</h3>
                      <p className="text-gray-400">hr@syntrionix.com</p>
                    </div>
                  </div>

                  <div className="flex items-start gap-4 group">
                    <div className="mt-1 p-3 bg-cyan-500/20 rounded-lg group-hover:bg-cyan-500/30 transition-colors">
                  ...
                  <div className="flex items-start gap-4 group">
                    <div className="mt-1 p-3 bg-purple-500/20 rounded-lg group-hover:bg-purple-500/30 transition-colors">
                      <Building2 className="w-6 h-6 text-purple-400" />
                    </div>
                    <div>
                      <h3 className="text-white font-semibold mb-1">Visit Us</h3>
                      <p className="text-gray-400">1839 W Spur Dr, Phoenix, AZ 85085, USA</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="relative bg-white/10 backdrop-blur-xl rounded-3xl border border-white/20 shadow-2xl hover:border-white/30 transition-all duration-300 overflow-hidden">
                  ...
                  <div className="bg-gradient-to-r from-blue-500/10 to-cyan-500/10 border-b border-white/10 p-8">
                    ...
                    <p className="text-gray-300">Fill out the form and we'll respond as soon as possible.</p>
                  </div>
                  ...
                  <div className="p-8 space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        ...
                        rows={5}
                        className="bg-white/5 border-white/10 text-white placeholder:text-gray-500 focus:border-blue-400 focus:ring-blue-400/20 resize-none"
                      />
                      {formErrors.message && (
